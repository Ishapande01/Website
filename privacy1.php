	...
	<br />
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The SneakerHead Incorporated respect the privacy of the visitors
					to the SneakerHead.com website and the local websites connected with it, and take great care to protect your
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While SneakerHead strives to protect its user's
...
<div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">SneakerHead Inc. 2017 Brought To You by <a href="https://code-projects.org/">Code-Projects</a></p>
		</div>
